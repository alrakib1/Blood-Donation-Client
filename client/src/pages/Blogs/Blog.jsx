      ...
      <div className=" h-full max-w-[300px] border rounded-md flex flex-col justify-between bg-gradient-to-r from-teal-500 to-teal-900 text-white shadow-lg">
          ...
          <div className="my-5">
            ...
            <div className="card-actions justify-center mt-auto">
             <Link to={`/details/${blog._id}`}> <button className=" py-1 px-2 rounded-md bg-white font-semibold hover:bg-blue-900 hover:text-white transition-all animate-pulse hover:animate-none  text-blue-950 outline-none border-none">Details</button></Link>
            </div>
          </div>
        </div>
