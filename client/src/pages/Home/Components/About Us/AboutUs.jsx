...
<div className="collapse border-b-2 bg-gradient-to-r from-teal-500 to-teal-900 text-white">
  ...
  <div className="collapse-content"> 
    <p>Blood donation is a selfless act that directly contributes to the health and recovery of patients facing various medical conditions, emergencies, and surgeries. By donating blood, you become a lifeline for someone in need, providing hope and a chance at a healthier future.</p>
  </div>
</div>
        </div>
    );
