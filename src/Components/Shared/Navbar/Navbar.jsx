...
const Navbar = () => {
    ...
    <li><NavLink to='/requests'>Donation Requests</NavLink></li>
  ...
  <div className="navbar-start">
    ...
    <Link to='/' className="btn btn-ghost text-xl"><img className="w-8" src="https://i.ibb.co/MZbwWpp/205916-removebg-preview.png" alt="" />Donate Blood</Link>
  </div>
